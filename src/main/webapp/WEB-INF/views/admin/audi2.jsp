...
--%>
<link href="${pageContext.request.contextPath }/resources/css/admin/audi2.css" rel="stylesheet">
	...
	<script type="text/javascript">
		$(function() {
			...
			function setHelpText() {
				...
				if (!ebox.setHelpTextForInput_TextWithSpace($('#aName'))) { return false; }
				/* if (!ebox.isValid($('#aName').val())) {
					$('#aName').parent().find('.help-block').css('visibility', 'visible');
					return false;
				} */
				if (!ebox.setHelpTextForInput_TextWithSpace($('#floor'))) { return false; }
						...
						<div class="panel-body ">
							...
							<div class="form-group-wrapper">
								...
								<div class="row">
									...
									<div class="form-group col-xs-4">
										<label>상영관 이름</label> <input type="text" name="aName" id="aName" class="form-control" placeholder="Enter Text">
										<p class="help-block text-fail">담당자를 입력해주세요.</p>
									</div>

									<div class="form-group  col-xs-4">
										<label>위치</label> <input type="text" name="floor" id="floor" class="form-control" placeholder="Enter Text">
										<p class="help-block text-fail">담당자를 입력해주세요.</p>
									</div>
