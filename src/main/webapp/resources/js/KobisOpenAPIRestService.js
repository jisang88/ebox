...
KobisOpenAPIRestService.prototype.reqMovieList = function(isJson, paramMap) {

	// return this.requestGet(this.key, this.host, this.MOVIE_LIST_URI, isJson,
	// paramMap);
	var urlStr = this.host + this.MOVIE_LIST_URI + (isJson ? '.json' : '.xml');
	var retVal = null;
	$.extend(paramMap, {
		key : this.key
	});
