...
public class PageMaker {
	...
	public String makeBasicQuery(int page) {
	...
	public String toString() {
		return "PageMaker [totalCnt=" + totalCnt + ", startPage=" + startPage + ", endPage=" + endPage + ", prev=" + prev + ", next=" + next + ", displayPageNum=" + displayPageNum
				+ ", cri=" + cri + "]";
	}
